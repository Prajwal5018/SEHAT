...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { title: "SEHAT — AI Workforce OS for Hospitals" },
      { name: "description", content: "AI-powered workforce operating system that monitors hospital operations and helps administrators make proactive decisions." },
    ],
    links: [
